...
symbols = [
   '20MICRONS','21STCENMGM','360ONE','3BBLACKBIO','3IINFOLTD','3MINDIA','3PLAND','5PAISA','63MOONS','A2ZINFRA','AAATECH','AADHARHFC','AAKASH',
    ...
    'ABBOTINDIA','ABCAPITAL','ABCOTS','ABDL','ABFRL','ABINFRA','ABLBL','ABMINTLLTD','ABMKNO','ABREL','ABSLAMC','ACC','ACCELYA','ACCURACY','ACE',
    'ACEINTEG','ACI','ACL','ACMESOLAR','ACSTECH','ACUTAAS','ADANIENSOL','ADANIENT','ADANIGREEN','ADANIPORTS','ADANIPOWER','ADFFOODS','ADL','ADOR',
    'ADROITINFO','ADSL','ADVAIT','ADVANCE','ADVANIHOTR','ADVENTHTL'
